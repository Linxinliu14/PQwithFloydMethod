...
public class PriorityQueueTest {
    ...
    public void testMax() {
        ...
        PriorityQueue<String> pq = new PriorityQueue<>(10, false, Comparator.comparing(String::toString),true);
    ...
    public void testSwimUp() {
        ...
        binHeap[1] = a;
        binHeap[2] = b;
        PriorityQueue<String> pq = new PriorityQueue<>(true, binHeap, 2, Comparator.comparing(String::toString),true);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSink() {
        ...
        binHeap[2] = b;
        binHeap[3] = c;
        PriorityQueue<String> pq = new PriorityQueue<>(true, binHeap, 3, Comparator.comparing(String::toString),true);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
